  ...
  <div>
    <div class="c-nav">
      <div class="container navFlex">
        <div class="flexItem">
          <img src="@/common/img/lastestlogo.png" style="position:relative;top:-6px" />
          <img
            src="@/common/img/logo4.png"
            style="height:30px;top:5px;position:relative;right:35px"
          />
        </div>
        <div class="flexItem hiden">
          <img @click="clickBtn" class="btnImg" src="/static/navBtn.png" />
        </div>
