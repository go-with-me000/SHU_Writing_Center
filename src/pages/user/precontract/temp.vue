<template>
  <div class="main">
    ...
    <Row>
      ...
      >
        <p slot="header" style="color:#000;text-align:center;height:30px;">
          <span style="position:relative;font-size:24px;font-weight:bold;top:20%">邮箱验证</span>
        </p>
        <div style="width:100%;position:relative">
        ...
        <div slot="footer" style="text-align:center">
          <Button type="primary" size="large" @click="hangbefore()" style="margin-right:1vh;">发起预约</Button>
          <Button
            type="primary"
            size="large"
            ghost
            @click="captchamodal=false"
            style="margin-right:1vh;"
          >取消</Button>
        </div>
      </Modal>
