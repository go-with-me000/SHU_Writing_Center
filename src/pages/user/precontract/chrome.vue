<template>
  <div class="main">
            ...
            <div class="introduce">
              ...
              <Row class="button" >
                <Col span="8" style="text-align:left">
                  <Button @click="specifics(item)" ghost type="default">详情</Button>
                </Col>
                <Col span="3">
                  <Button ghost type="default" @click="precontract(item)">预约</Button>
                </Col>
              </Row>
              <!-- <ul>
                <li>
    ...
    <Row>
      <Modal v-model="modal1" :closable="false" width="35%" :styles="{top: '60px'}">
        <Card>
          <Row class="stitle">
            <span style="font-weight:normal">教师姓名:</span>
            {{item.teachername}}
            <div id="rate">
              评分：
...
export default {
  ...
  methods: {
    ...
    hangbefore() {
      let URL = `${apiPath}/user/checkMsgCode`;this.spinShow = true;
      this.article.essayFlag = false;
      axios({
        url: URL,
        method: "get",
        params: {
            ...
            if (res.data.code === 200) {
              ...
              if (res.data.data != "暂时没有教师") {
                ...
                for (let i = 0; i < this.data.length; i++) {
                  ...
                  this.data[i].building = "上海大学宝山校区本部图书馆二楼东侧";
    ...
    precontract(item) {
      ...
      if (email != "" && email != null && email != undefined && email !="noemail") {
        this.item = item;
    ...
    handleBeforeUpload(file) {
      ...
      axios
        ...
        .then(res => {
          ...
          // this.article.essaysrc = "https://202.120.117.43/" + res.data;
          this.article.essaysrc = "https://writingcenter.shu.edu.cn/" + res.data;
        });
      return false;
    }
  },
  watch: {
    ...
    choose: {
      handler(newVal, oldVal) {
        ...
        this.tag = false;
        if (this.choose.academy != "" || this.choose.campus != "全部") {
          this.tag3 = true;
          this.teacherName = "";
        }
      },
