    ...
    <Row type="flex" justify="center" class="code-row-bg">
        ...
        <div class="content">
          ...
          >
            ...
            <FormItem label="职称" prop="job">
              <Input v-model="person_info.job" placeholder="请输入您的职称" :disabled="disable_impl"></Input>
            </FormItem>
      ...
      <Col span="2" style="text-align:center;">
        <div class="displayimg">
          ...
          >
            <Button icon="ios-cloud-upload-outline" type="success" ghost  style="width:270px">点击此处上传照片</Button>
          </Upload>
          <div class="display">
          ...
          <!-- <div class="qrcode">
            ...
            <p style="font-weight:bold;font-size:14px;">请老师扫二维码，关注公众号</p>
