  ...
  <Layout>
    <Layout
      ...
      :style="{margin: '0px', background: '#fff', minHeight: '220px',
         backgroundImage:'url(https://writingcenter.shu.edu.cn/group1/M00/00/03/ynh1K19nPteADxk9AALd7dOSFcY429.jpg)',
         backgroundRepeat:'no-repeat',backgroundSize:'100% 100%',
          }"
    >
      <Layout class="backs"></Layout>
      <div class="intbutton" @click="go">
        <Poptip content="中心介绍" trigger="hover" class="arrow" placement="left"></Poptip>
      </div>

      <div class="texts">
        <p class="title1">上海大学写作中心</p>
        <!-- <p style=" position: relative;font-size:50px;">国际学术交流写作中心</p> -->
        <p class="title2">SHU Writing Center</p>
        <p class="title2">一站式写作教学、写作服务、写作科研的平台</p>
    ...
    <div>
                ...
                <div class="col-sm-6">
                  <div class="portfolio-item">
                    <div class="hover-bg">
                      ...
                      <span>专家问诊</span>
                      <img
                        src="@/common/img/portfolio/onebyone.jpg"
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 web">
                  <div class="portfolio-item">
                    <div class="hover-bg">
                      ...
                      <span>同伴辅导</span>
                      <img
                        src="@/common/img/portfolio/friend.jpg"
                        class="img-responsive"
                        alt="Project Title"
                      />
                    </div>
                ...
                <div class="col-sm-6">
                  <div class="portfolio-item">
                    <div class="hover-bg">
                      ...
                      <span>信息素养培训</span>
                      <img
                        src="@/common/img/portfolio/train.jpg"
                        class="img-responsive"
                        alt="Project Title"
                      />
                    </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 web">
                  <div class="portfolio-item">
                    <div class="hover-bg">
                      ...
                      <span>英语写作工作坊</span>
                      <img
                        src="@/common/img/portfolio/work.jpg"
                        class="img-responsive"
                        alt="Project Title"
                      />
                    </div>
      ...
      <div class="mobile5">
        <h3 style="text-align: center;font-size: 34px; color: rgb(36, 80, 134);">工作团队</h3>
        <h3
          style="text-align: center;font-size: 34px; color: rgb(36, 80, 134);margin-bottom:50px"
        >work team</h3>
      ...
      <div id="section3">
        ...
        <Row>
          ...
          <Col span="6" offset="1">
            <img src="@/common/images/q2.jpg" style="width:80%;height:100%;" />
            <h4>面对面方式传授写作经验</h4>
          </Col>
          <Col span="6" offset="1">
            <img src="@/common/images/q3.jpg" style="width:80%;height:100%;" />
            <h4>分享实用的写作技巧</h4>
          </Col>
        </Row>
      </div>
      ...
      <div class="mobile4">
        <h3 style="text-align: center;font-size: 34px; color: rgb(36, 80, 134);">写作预约</h3>
        <h3
          style="text-align: center;font-size: 34px; color: rgb(36, 80, 134); padding: 5px 5px 15px 5px"
        >appointment</h3>
        <Steps direction="vertical" id="step">
          <Step status="process" title="申请预约" content="登录上海大学写作中心网站，申请想要预约的导师，上传自己想要被辅导的论文"></Step>
          <Step status="process" title="导师确认" content="导师根据论文质量和辅导方向，确认预约"></Step>
          <Step status="process" title="写作辅导" content="预约确认后，按照时间地点进行写作辅导"></Step>
          <Step status="process" title="完成辅导" content="辅导完成后，填写调查问卷，以便下次进行预约"></Step>
...
export default {
  data() {
    return {
      ...
      introduce11:
        "上海大学写作中心从学生自身需求出发，由学生自发组织管理，以“恪守学术道德、坚守学术诚信，服务学生写作需求”为宗旨，致力于提升学生的学术能力和写作水平。上海大学写作中心向学生传递学术规范，提升论文梳理与呈现能力，强化底线意识，是学校贯彻高水平大学建设、落实立德树人、促进研究生论文基础写作水平整体提升的重要平台。",
      introduce2:
        "上海大学写作中心秉承“提高学术写作水平是我们共同的努力”的理念，自成立以来，不断加强管理队伍建设，通过整合各方资源，基本形成了以“信息素养培训”、“英语写作工作坊”、“一对一辅导”三轮驱动的服务体系。其中尤以一对一辅导，即“专家问诊”和“同伴辅导”，作为本中心的特色王牌服务。",
      introduce3:
        "上海大学写作中心由上海大学研究生院直接指导，贯彻学生“自我管理、自我教育、自我服务、自我监督”理念，由学生组织和管理，成立了包括策划部、联络部、执行部、宣传部和视觉部等五大部门。",
      section1:
...
@import "./mobile/style2.css";
@import "./mobile/pic.css";
