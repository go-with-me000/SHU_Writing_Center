  ...
  <div>
    <Row>
      <Tabs :value="theIdentity" class="tabs" @on-click="tabClick">
        <TabPane label="预约发起" name="student" icon="md-bookmarks" style="margin-bottom:30px">
          <div class="checkbox">
            审核
            ...
            <i-switch v-model="Status1.fail" style="margin-right: 5px"></i-switch>过期
            <i-switch v-model="Status1.expired" style="margin-right: 5px"></i-switch>
            <!-- <Button
              icon="ios-refresh"
        ...
        <TabPane label="预约接收" name="teacher" icon="ios-folder" v-if="identity!='ROLE_Student'">
          <div class="checkbox">
            ...
            <i-switch v-model="Status2.fail" style="margin-right: 15px"></i-switch>过期
            <i-switch v-model="Status2.expired" style="margin-right: 15px"></i-switch>
            <!-- <Button
              icon="ios-refresh"
              style="margin-top:0px"
              type="success"
    ...
    <Modal v-model="modal1" class-name="vertical-center-modal" :styles="{top: '150px'}">
      ...
      <div slot="footer" style="text-align:center">
        <!-- <Button type="success" size="large" @click="again()" style="margin-right:1vh;">重新预约</!--> -->
...
export default {
  ...
  methods: {
    ...
    loadData1() {
      ...
      let expired = this.Status1.expired;
    ...
    loadData2() {
      ...
      let expired = this.Status2.expired;
      let page = this.page;
      axios({
        url: URL,
        method: "post",
...
this.spinShow=false;
    ...
    handleBeforeUpload(file) {
      ...
      this.loading = true;
      axios
        .post(`https:${apiPath}/uploadfile`, formData, {
